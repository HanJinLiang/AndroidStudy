...
public class CustomerRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = CustomerRefreshLayout.class.getSimpleName();
     ...
     * @param context
     */
    public CustomerRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public CustomerRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(CustomerRefreshLayout parent, @Nullable View child);
    }
}
